...
public class StyleFactory
{
    ...
    /// 自动换行样式
    /// </summary>
    public ICellStyle WrapStyle { get { return GetStyle(new() { HorizontalAlignment = (int)HorizontalAlignment.Left, VerticalAlignment = ((int)VerticalAlignment.Center), WrapText = true }); } }
